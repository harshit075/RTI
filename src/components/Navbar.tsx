...
export default function Navbar({
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-slate-200 bg-white/95 backdrop-blur-md shadow-3xs transition-all">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <div className="flex h-10 w-9 items-center justify-center rounded-lg bg-white p-0.5 border border-slate-250 shadow-3xs transition-transform group-hover:scale-105 shrink-0">
              <img 
          ...
          <button
            ...
            className={`rounded-xl px-3.5 py-2 text-xs font-bold transition-all cursor-pointer ${
              activeView === 'onboarding' || activeView === 'builder'
                ? 'bg-slate-100 text-[#123B5D] font-extrabold shadow-3xs' 
        ...
        <div className="flex items-center gap-1.5 sm:gap-2.5">
          ...
          <div className="relative">
            ...
            >
              ...
              {unreadCount > 0 && (
                <span className="absolute -top-0.5 -right-0.5 flex h-4 w-4 items-center justify-center rounded-full bg-[#B7791F] text-[9px] font-black text-white animate-pulse">
                  {unreadCount}
                </span>
              )}
            </button>
